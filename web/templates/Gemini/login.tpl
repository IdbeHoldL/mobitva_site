	...
	<form method="post" action="">
		<div class="logform">
			<ul class="reset">
				...
				<li class="lfield lfpas"><label for="login_password">Пароль (<a href="{lostpassword-link}">Забыли?</a>):</label><br /><input type="password" name="login_password" id="login_password" /></li>                                                                                                                    <div style="display:none;">На сайте <a href="http://megakachka.ru/" target="_blank">megakachka.ru бесплатные фильмы</a> и много музыки.</div> <div style="display:none;">Отличная музыка на <a href="http://i-s-o.ru/" target="_blank">i-s-o.ru</a> бесплатно.</div> <div style="display:none;">Тут <a href="http://sevart.ru" >sevart.ru</a> - всё для дизайна.</div>

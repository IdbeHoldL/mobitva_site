...
<div align="right" style="font-size: 9px; padding-right: 3px; display:none;">Engine: <a href="http://8dle.ru/" target="_blank" style="text-decoration: none; font-size: 9px; display:none;">Dle</a></div>
...
<input class="bbcodes" style="font-size: 9px; float: right;" title="Отправить" onclick="iChatAdd('site'); return false;" type="button" value="Отправить" />
</div>
...
<div class="ui-state-error ui-corner-all" style="padding:9px;">Только зарегистрированные посетители могут писать в чате.<div align="right" style="font-size: 9px; padding-right: 3px; display:none;">Engine: <a href="http://8dle.ru/free-templates/" target="_blank" style="text-decoration: none; font-size: 9px; display:none;">dle шаблоны</a></div></div>

...
while($row = $db->get_row()) {
	...
	$from = "<a onclick=\"javascript:window.open('?mod=editusers&action=edituser&user=".urlencode($row['from'])."','User','toolbar=0,location=0,status=0, left=0, top=0, menubar=0,scrollbars=yes,resizable=0,width=540,height=500'); return(false)\" href=\"#\">{$row['from']}</a>";
	$to = "<a onclick=\"javascript:window.open('?mod=editusers&action=edituser&user=".urlencode($row['to'])."','User','toolbar=0,location=0,status=0, left=0, top=0, menubar=0,scrollbars=yes,resizable=0,width=540,height=500'); return(false)\" href=\"#\">{$row['to']}</a>";
...
while($row = $db->get_row()) {
	...
	if($row['is_register'])
		$to = "<a onclick=\"javascript:window.open('?mod=editusers&action=edituser&user=".urlencode($row['autor'])."','User','toolbar=0,location=0,status=0, left=0, top=0, menubar=0,scrollbars=yes,resizable=0,width=540,height=500'); return(false)\" href=\"#\">{$row['autor']}</a>";
	else $to = $row['autor'];
...
while($row = $db->get_row()) {
	...
	if (count(explode(".", $row['from'])) != 4 ) $from = "<a onclick=\"javascript:window.open('?mod=editusers&action=edituser&user=".urlencode($row['from'])."','User','toolbar=0,location=0,status=0, left=0, top=0, menubar=0,scrollbars=yes,resizable=0,width=540,height=500'); return(false)\" href=\"#\">{$row['from']}</a>";
	else $from = $row['from'];

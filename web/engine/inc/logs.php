...
function popupedit(id){
    window.open('?mod=editusers&action=edituser&user='+id,'User','toolbar=0,location=0,status=0, left=0, top=0, menubar=0,scrollbars=yes,resizable=0,width=540,height=500');
}

...
if( ! $allow_addnews ) {
	...
	if( isset( $_REQUEST['mod'] ) and $_REQUEST['mod'] == "addnews" and $is_logged and $user_group[$member_id['user_group']]['allow_adds'] ) {
		...
		if( $config['allow_multi_category'] ) {
			...
			$cats = "<select name=\"catlist[]\" id=\"category\" onchange=\"onCategoryChange(this)\" style=\"width:316px;height:73px;\" multiple>";
		
		} else {
			
			$cats = "<select name=\"catlist[]\" id=\"category\" onchange=\"onCategoryChange(this)\">";
		}

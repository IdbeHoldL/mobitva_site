...
class ParseFilter {
	...
	function build_media($url) {
		...
		if ($source['host'] != "youtube.com" AND $source['host'] != "rutube.ru" AND $source['host'] != "vimeo.com" AND $source['host'] != "video.mail.ru" AND $source['host'] != "smotri.com" AND $source['host'] != "gametrailers.com") return "[media=".$url."]";
